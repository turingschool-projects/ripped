...
describe "/users/:id" do
  it "a user can see a list of exercises in progress on their dashboard" do
    ...
    solution1 = create(:solution, exercise_id: exercise1.id, user_id: user.id, status: "Submitted")
    solution2 = create(:solution, exercise_id: exercise2.id, user_id: user.id, status: "Solved")
